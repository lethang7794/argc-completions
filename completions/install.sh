...
# @flag -c                                     (ignored)
# @flag -C --compare                           compare content of source and destination files, and if no change to content, ownership, and permissions, do not modify the destination at all
...
# @flag -v --verbose                           print the name of each created file or directory
