...
# @option --vendor[cisco|netscreen]               vendor of your IPSec gateway Default: cisco
...
# @option --pid-file <filename>                   store the pid of background process in <filename> Default: /var/run/vpnc.pid
